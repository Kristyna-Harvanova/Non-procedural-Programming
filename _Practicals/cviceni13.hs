...
-- pokracovani 12. cvičení 2024-05-14 (zruseno 13. cvičení 2024-05-07)
--
...
-- program, ktery precte obsah souboru numbers.txt a na standartni vystup vypise soucet vsech cisel v souboru
-- jedno cislo na jednom radku
...
sumUp = do
    ...
    let strings = lines content
        numbers = map read strings :: [Integer]
        resultInt = sum numbers
        resultString = show resultInt
