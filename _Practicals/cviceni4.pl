...
% X = 1; 2; 3; 6 (rez je lokalni, takze funguje jen v ramci R(), to obsahuje i S(4), takze to se nezavola, ale potom P(6) normalne pokracuje) 
...
% Delka seznamu pomoci foldl
:- use_module(library(clpfd)).  % potom napiseme # a funguje obousmerne. viz komentar
